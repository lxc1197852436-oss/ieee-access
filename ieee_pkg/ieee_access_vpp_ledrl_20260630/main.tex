...
\midrule
Real DE-LU price + real weather (3-week) & \textbf{+__NEW_GAP__} & [+__NEW_CI_LO__, +__NEW_CI_HI__] & __NEW_FAV__/5 \\
\bottomrule
\end{tabular}
\end{table}
